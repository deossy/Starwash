...
<html lang="en">
  ...
  <body>
    ...
    <header class="jumbotron bg-inverse text-xs-center center-vertically" role="banner">
      <div class="container">
        <h1 class="display-3">Star wash </h1>
        <h2 class="m-b-3">Budayakan malas mencuci, karena mencuci adalah tugas kami<br><a href="ui-elements.html" class="jumbolink"></a></h2>
        <div class="tombol" >
        <a href="login/index.php"><button type="button" class="btn btn-success btn-md " >Login </button></a>
  </div>
          </li>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-5">
            <div class="media">
              ...
              <small class="media-body media-bottom">
                &copy; Star Wash 2022. <br>
                Designed by DESSY ANGGRAENI
              </small>
            </div>
          </div>
          <div class="col-md-6 col-lg-7">
            <ul class="nav nav-inline">
              <li class="nav-item">
                <a class="nav-link" href="">Tugas Akhir SMK Negeri 1 Cimahi<span class="sr-only"></span></a>
              </li>
            </ul>
          </div>
        </div>
